        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($consulta_usuario = mysqli_fetch_assoc($result))
                {
                    ...
                    <a  class='btn-edit btn btn-sm btn-warning' href='editaPF.php?id_pf=$consulta_usuario[id_pf]'>
                    ...
                    echo "<td>
                    <div class='btn-group'>
                    <a class='btn btn-sm btn-dark' href='deletePf.php?id_pf=$consulta_usuario[id_pf]'>
