...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		<div class="col-sm-1 col-sm-offset-1"><img src="foto_produto/<?php echo $exibe_busca['pasta_imagem']; ?>/<?php echo trim($exibe_busca['imagem_produto']); ?>.jpg" class="img-responsive imgm"><!--busca a imagem do produto--></div>
