...
<div class="nomecat">
  ...
  <?php   while($exibe = $consulta->fetch_assoc()){  ?>
    ...
    <div class = "bvvvxW " >
      ...
      <img src="foto_produto/<?php echo $exibe['pasta_imagem']; ?>/<?php echo trim($exibe['imagem_produto']); ?>.jpg" class="img-responsive imgm" > <!--TRIM remove todos os possiveis espaços que podem atrapalhar o código-->
